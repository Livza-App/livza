...
public class MenuitemAdapter extends ArrayAdapter<Fooditem> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        time.setText(food.get(position).getTime());
        price = rowView.findViewById(R.id.price);
        price.setText(food.get(position).getPrice());
        title = rowView.findViewById(R.id.foodtitle);
        title.setText(food.get(position).getTitle());
        subtitle = rowView.findViewById(R.id.subtitle);
        subtitle.setText(food.get(position).getSubtitle());
        rating = rowView.findViewById(R.id.rating);
        rating.setText(food.get(position).getRating());
